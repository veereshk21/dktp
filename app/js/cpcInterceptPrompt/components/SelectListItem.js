...
export default class SelectListItem extends React.Component { // eslint-disable-line
  render() {
    return (
      <div className={`${this.props.className} clearfix  fontSize_6`}>
        <a aria-label={`${this.props.title} ${(this.props.value ? this.props.value : '')}`} className="block color_000 clearfix" role="button" href="df" onClick={this.props.onClickMethod}>
          <div className="">
