  ...
  output: {
    ...
    shippingInfo: {
      ...
      addressInfo: {
        ...
        lastName: "JONES",
        companyName: null,
        address1: "20046 GREAT FALLS FOREST DR",
        address2: null,
        city: "Great Falls",
        state: "VA",
        zipcode: "22066",
      ...
      shippingTypesInfo: [
        {
          estimatedDeliveryDate: "2017-09-22 00:00:00",
          estimatedDeliveryDateText: "Friday 9/22",
          ...
          description:
            "Estimated to arrive on Fri, Sep 22 if ordered by 4pm today. Signature required.",
    ...
    deviceConfigInfo: {
      devices: [
        {
          deviceId: "SDC9578e7395ee134837447fc7b6b78e5a3{d6}_device_1",
          deviceName: "iPhone&reg; 8 Plus",
          deviceSetupMode: null,
          mtnNumber: "7039660112",
          flow: "EUP",
          serviceAddress: {
            firstName: "RYAN",
            lastName: "JONES",
          ...
          deviceImageUrl:
            "https://ss7.vzw.com/is/image/VerizonWireless/iPhone8Plus-Svr?$device-med$&fmt=jpeg&wid=75&hei=150",
          mobileAppImageName: null,
          npaNxxnumber: "571-455-XXXX",
    ...
    authInfo: {
      clients: {
        CARDINAL3DSECURE: {
          token:
            "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..l6bX645B6zoFyE890E_AjWOso53FpPG0mIT2WKV1DpQ",
          tokenType: "JWT",
          featuresList: { binDetection: true }
        }
      }
    },
    giftCard1Info: null,
      ...
      items: [
        {
          ...
          optionalFeatures: [],
          installmentBalance: "949.99",
          edgeRetailPrice: "949.99",
          edgeItemDownPaymentAmount: "0.00",
          mailInRebateAmount: "0.00",
          transferredFromMtn: "7039669501",
          ...
          promoOfferText: null,
          promoApplied: false,
          commerceItemId: "SDC9578e7395ee134837447fc7b6b78e5a3{d6}_device_1",
          loanTerm: 24,
          sbdHeaderMsg: null,
          percentage: null,
    ...
    dueMonthlyView: {
      ...
      dueMonthlyPrice: "59.58",
      items: [
        {
          name: "iPhone&reg; 8 Plus",
          description: "iPhone&reg; 8 Plus",
          manufacturer: "Apple",
          color: "Silver",
          size: "256GB",
          priceBreakDown: [
            ...
            },
            {
              ...
              price: "39.58",
              description: "For 24 months, 0% APR Retail price: $949.99",
              linkText: null,
              linkUrl: null,
              originalPrice: 0.0,
              tmpMdOpted: false,
        ...
        items: [
          {
            name: "Taxes & Fees",
            price: "58.80",
            description: "Great Falls, VA"
          },
          { name: "FREE 2 Day by 8pm", price: "0.00", description: null }
        ]
      },
      price: null
    },
    ...
    handleCardinalResponseURL:
      "/od/cust/auth/checkout/handleCardinal3DResponse",
    pastDueCheckoutURL: "/od/cust/auth/checkout/pastDueCheckout",
    updateDeviceServiceAddressURL:
      "/od/cust/auth/checkout/updateDeviceServiceAddress",
